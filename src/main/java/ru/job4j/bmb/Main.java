...
public class Main {
    ...
    CommandLineRunner loadDatabase(MoodRepository moodRepository,
        ...
        return args -> {
            ...
            awards.add(new Award("Настроение недели", "За 7 последовательных дней хорошего или "
                    + "отличного настроения.", 7));
            ...
            awards.add(new Award("Титул 'Лучезарный'",
                    "За 20 дней хорошего или отличного настроения.", 20));
            ...
            awards.add(new Award("Награда 'Настроение месяца'", "За поддержание хорошего или отличного"
                    + " настроения в течение целого месяца.", 31));
            ...
            awards.add(new Award("Персональное поздравление", "За значимые достижения "
                    + "(например, 50 дней хорошего настроения).", 50));
